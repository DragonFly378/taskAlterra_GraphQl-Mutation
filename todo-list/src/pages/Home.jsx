...
const Home = () => {
  // const { data, loading, error, refetch } = useQuery(GetLists);
        ...
        <div className="container">
          ...
          <div className="konten">
            ...
            <div className="showtask">
              {/* kalau mau pakai lazyQuery */}
              <button onClick={onGetData}>Get Tasks</button>
              <button onClick={onGetData}>Refetch</button>
